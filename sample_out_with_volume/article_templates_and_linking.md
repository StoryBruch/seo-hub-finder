...
Hub verlinkt auf alle validierten Spoke-Artikel. Jeder Spoke verlinkt zurück zum Hub, auf 2-4 verwandte Spokes und auf relevante Produkt-/Conversion-Seiten.

### Risks / human review
Human/AI review required: thin content, cannibalization, duplicated intent, missing unique slot information.

## Für Pattern Hub
**Hub URL:** `/fur-pattern-hub/`
**Pattern:** `{slot_1} für {slot_2}`
**URL template:** `/{slot_1}-fur-{slot_2}/`
...
## Entkalken Hub
**Hub URL:** `/entkalken-hub/`
**Pattern:** `{slot_1} entkalken`
**URL template:** `/{slot_1}-entkalken/`
...
## Reinigen Hub
**Hub URL:** `/reinigen-hub/`
**Pattern:** `{slot_1} reinigen`
**URL template:** `/{slot_1}-reinigen/`
...
## Alternative Pattern Hub
**Hub URL:** `/alternative-pattern-hub/`
**Pattern:** `alternative {slot_1}`
**URL template:** `/alternative-{slot_1}/`
...
## Reinigungstabletten Hub
**Hub URL:** `/reinigungstabletten-hub/`
**Pattern:** `{slot_1} reinigungstabletten`
**URL template:** `/{slot_1}-reinigungstabletten/`
...
## Zu Pattern Hub
**Hub URL:** `/zu-pattern-hub/`
**Pattern:** `{slot_1} zu {slot_2}`
**URL template:** `/{slot_1}-zu-{slot_2}/`
